...
#define CSR_APP_LTSSM_EN_GEN3		0x54
#define CSR_APP_READY_ENTR_L23_GEN3	0x68
...
/* sysreg */
#define FSYS0_PCIE_GEN3_4L_PHY_CTRL	0x800
#define FSYS0_PCIE_GEN3_2L0_PHY_CTRL	0x804
#define FSYS0_PCIE_GEN3_2L1_PHY_CTRL	0x808
...
#define LINK_DOWN		(0x1 << 10)
#define SMLH_LINK_DISABLE	(0x1 << 9)
#define PERST_N_1		(0x1 << 8)
#define PERST_N_0		(0x1 << 7)
...
//Doorbell
#define PCIE_DOORBELL_CH_OFFSET		(0x10000)
#define PCIE_DOORBELL_BASE_ADDRESS	(0x17B30000)
...
//SR-IOV
#define PCIE_SRIOV_CAP_POS	(0x168)
...
struct pcie_ep_phyops {
	...
	void (*phy_config)(struct exynos_ep_pcie_phyinfo *phyinfo);
